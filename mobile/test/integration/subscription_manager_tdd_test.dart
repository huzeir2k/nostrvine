  ...
  group('SubscriptionManager TDD - Real Relay Tests', () {
    ...
    test(
      ...
      final subscriptionId = await subscriptionManager.createSubscription(
        ...
        onError: (error) {
          Log.error('❌ TDD: SubscriptionManager error: $error',
              name: 'SubscriptionManagerTDDIntegrationTest',
              category: LogCategory.system);
        ...
        onComplete: () {
          Log.debug('🏁 TDD: SubscriptionManager subscription completed',
              name: 'SubscriptionManagerTDDIntegrationTest',
              category: LogCategory.system);
          if (!completer.isCompleted) {
            completer.complete();
    ...
    test(
        ...
        () async {
      Log.debug('🔍 TDD: Testing direct subscription as control test...',
          name: 'SubscriptionManagerTDDIntegrationTest',
          category: LogCategory.system);
      ...
      final directSub = directStream.listen(
        ...
        onError: (error) {
          Log.error('❌ TDD: Direct subscription error: $error',
              name: 'SubscriptionManagerTDDIntegrationTest',
              category: LogCategory.system);
      ...
      try {
        ...
        Log.warning('⏰ TDD: Timeout waiting for direct events',
            name: 'SubscriptionManagerTDDIntegrationTest',
            category: LogCategory.system);
      }
