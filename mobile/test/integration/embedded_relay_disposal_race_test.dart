...
void main() {
  ...
  group('Embedded Relay Disposal Race Condition', () {
    ...
    test('FAILING: should not throw "Cannot add new events after calling close" during disposal with active subscription',
        () async {
      ...
      expect(
        errors.where((e) => e.contains('Cannot add new events after calling close')).isEmpty,
        true,
        reason: 'Should not have "Cannot add new events after calling close" errors during disposal',
      );
    ...
    test('FAILING: should handle rapid dispose-reinitialize cycles without errors',
        () async {
